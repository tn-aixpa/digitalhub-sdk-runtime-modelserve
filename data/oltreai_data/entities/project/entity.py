...
from oltreai_core.entities.project.entity.core import CTX_ENTITIES, FUNC_MAP, ProjectCore
from oltreai_data.entities.dataitem.crud import (
...
class ProjectData(ProjectCore):
    ...
    def _parse_dict(obj: dict, validate: bool = True) -> dict:
        ...
        """
        # Override methods to search in oltreai_data
