...
from oltreai_core.entities._base.crud import get_data_api, set_data_api
...
if typing.TYPE_CHECKING:
    ...
    from oltreai_core.entities.secret.spec import SecretSpec
    from oltreai_core.entities.secret.status import SecretStatus
