...
from oltreai_core.entities._base.crud import files_info_get_api, files_info_put_api
from oltreai_core.entities._base.entity.versioned import VersionedEntity
from oltreai_core.stores.builder import get_store

if typing.TYPE_CHECKING:
    from oltreai_core.entities._base.metadata import Metadata
    from oltreai_core.entities._base.spec.material import MaterialSpec
    from oltreai_core.entities._base.status.material import MaterialStatus
