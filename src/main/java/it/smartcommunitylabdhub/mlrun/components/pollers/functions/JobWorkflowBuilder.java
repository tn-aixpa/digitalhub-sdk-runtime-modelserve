                ...
                Function<Object[], Object> getRunUpdate = params -> {
                        ...
                        try {
                                ...
                                return Optional.ofNullable(response.getBody()).map(body -> {
                                        Map<String, Object> status = (Map<String, Object>) ((Map<String, Object>) body
                                                        .get("data"))
                                                        .get("status");

                                        if (!stateMachine.getCurrentState()
                                                        .equals(RunState.valueOf(status.get("state").toString()
                                                                        .toUpperCase()))) {

                                                String mlrunState = status.get("state").toString();
                                                stateMachine.processEvent(
                                                                Optional.ofNullable(RunEvent
                                                                                .valueOf(mlrunState.toUpperCase()))
                                                                        ...
                                                                        metadata -> {
                                                                                ((List<Map<String, Object>>) metadata
                                                                                                ...
                                                                                                .forEach(artifact -> {
                                                                                                        ...
                                                                                                        // Create
                                                                                                        // artifact
                                                                                                        ArtifactDTO artifactDTO = ArtifactDTO
                                                                                                                        .builder()
                                                                                                        ...
                                                                                                        // Store
                                                                                                        // artifact
                                                                                                        artifactDTO = this.artifactService
                                                                                                                        .createArtifact(artifactDTO);
