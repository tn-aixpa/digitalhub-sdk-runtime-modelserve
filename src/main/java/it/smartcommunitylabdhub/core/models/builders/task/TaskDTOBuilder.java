...
@Component
public class TaskDTOBuilder extends TaskSpecBuilder {
        ...
        public TaskDTO build(Task task) {
                ...
                // Find base task spec
                TaskSpec taskSpec = (TaskSpec) specRegistry.createSpec(task.getKind(), spec);

                // Add base spec to the one stored in db
                spec.putAll(getBaseSpec(taskSpec));
