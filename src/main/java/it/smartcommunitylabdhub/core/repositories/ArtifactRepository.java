...
public interface ArtifactRepository extends JpaRepository<Artifact, String> {
    ...
    Page<Artifact> findAllByProjectAndNameOrderByCreatedDesc(String project, String name,
                                                             Pageable pageable);
    ...
    Page<Artifact> findAllLatestArtifactsByProject(@Param("project") String project,
                                                   Pageable pageable);

    Optional<Artifact> findByProjectAndNameAndId(@Param("project") String project,
