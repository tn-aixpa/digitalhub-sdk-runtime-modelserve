...
from oltreai_core.entities.artifact.crud import artifact_from_dict
...
from oltreai_ml.entities.model.crud import model_from_dict
from oltreai_ml.entities.project.crud import get_project
