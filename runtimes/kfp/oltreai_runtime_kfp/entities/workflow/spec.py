...
from oltreai_core.entities.workflow.spec import WorkflowParams, WorkflowSpec
from oltreai_runtime_kfp.entities.workflow.models import SourceCodeParamsKfp, SourceCodeStructKfp
