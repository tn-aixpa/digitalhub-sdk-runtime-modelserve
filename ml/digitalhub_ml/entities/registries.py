...
status_registry.register("model", "digitalhub_ml.entities.models.status", "ModelStatus")

spec_registry = SpecRegistry()
spec_registry.register("model", "digitalhub_ml.entities.models.spec", "ModelSpec", "ModelParams")
