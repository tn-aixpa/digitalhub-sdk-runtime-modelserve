...
from oltreai_data.entities.project.entity import CTX_ENTITIES, FUNC_MAP, ProjectData
from oltreai_ml.entities.entity_types import EntityTypes
from oltreai_ml.entities.model.crud import (
...
if typing.TYPE_CHECKING:
    from oltreai_ml.entities.model.entity import Model
...
class ProjectMl(ProjectData):
    ...
    def _parse_dict(obj: dict, validate: bool = True) -> dict:
        ...
        """
        # Override methods to search in oltreai_ml
