...
from oltreai_ml.entities.project.entity import project_from_dict, project_from_parameters

if typing.TYPE_CHECKING:
    from oltreai_ml.entities.project.entity import ProjectMl as Project
