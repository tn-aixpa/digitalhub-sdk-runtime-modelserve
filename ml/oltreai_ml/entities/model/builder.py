...
if typing.TYPE_CHECKING:
    from oltreai_ml.entities.model.entity._base import Model

# Manage class mapper
cls_mapper = {}

try:
    from oltreai_ml.entities.model.entity.model import ModelModel
...
try:
    from oltreai_ml.entities.model.entity.mlflow import ModelMlflow

    cls_mapper["mlflow"] = ModelMlflow
except ImportError:
    ...
try:
    from oltreai_ml.entities.model.entity.pickle import ModelPickle

    cls_mapper["pickle"] = ModelPickle
except ImportError:
    ...
try:
    from oltreai_ml.entities.model.entity.huggingface import ModelHuggingface
